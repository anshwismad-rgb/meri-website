        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-3">
          {CHANNELS.map((channel) => (
            <a
              key={channel.label}
              href={channel.href}
              className="glass flex cursor-pointer flex-col items-center gap-3 rounded-3xl p-6 text-center transition-colors hover:bg-white/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring"
            >
