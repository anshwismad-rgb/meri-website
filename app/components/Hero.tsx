  ...
  return (
    <section id="top" className="relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-6xl px-4 pt-24 pb-20 text-center sm:px-6 sm:pt-32 sm:pb-28">
        <span className="glass inline-block rounded-full px-4 py-1.5 text-sm font-medium text-muted-foreground">
          Web Development &amp; Digital Marketing
        </span>

        <h1 className="font-display mx-auto mt-8 max-w-3xl text-5xl font-bold leading-[1.05] tracking-tight sm:text-6xl">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          <a
            href="#work"
            className="glass inline-flex cursor-pointer items-center justify-center rounded-full px-7 py-3.5 text-base font-semibold transition-colors hover:bg-white/10 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring"
          >
            See Our Work
          </a>
        </div>
